...
public partial class BT_AdaptiveNode : BT_Node
{
	...
	public virtual void BeforeAdaptativeAction(Node2D actor, Blackboard blackboard = null)
	{
		GD.PrintErr("Before Adaptative  method not implemented in " + GetType().Name);
	}
	public virtual void AfterAdaptativeAction(Node2D actor, Blackboard blackboard = null)
	{
